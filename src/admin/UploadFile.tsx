      ...
      <form onSubmit={onSubmit} className="space-y-6">
            ...
            {file ? (
              <div className="flex items-center justify-center gap-3">
                ...
                <div className="text-left">
                  <div className="text-sm font-bold truncate max-w-[260px]">
                    {file.name}
                  </div>
        ...
        {success && (
          <div className="text-xs text-emerald-400 bg-emerald-500/5 border border-emerald-500/20 rounded-lg px-4 py-3 flex items-center gap-2">
            <CheckCircle2 className="w-4 h-4" /> Configuração publicada e visível no site
            público.
          </div>
        )}
        ...
        >
          {submitting ? (
            ...
            <>
              <Upload className="w-4 h-4" /> ENVIAR FICHEIRO
            </>
          )}
        </button>
      </form>
